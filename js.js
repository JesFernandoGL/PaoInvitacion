...
function activateCounter(){
    const diffTime = new Date('2026-03-21T00:00:00') - new Date();
...
function animationsInit(){
    ...
    $('.InvImgContent-Img').click(function(){
      ...
      photosLeft = new WOW(
        {
        boxClass:     'Timeline-Memory:nth-of-type(2n+1)',      // default
        animateClass: 'animate__backInLeft', // default
        offset:       300,          // default
        mobile:       true,       // default
        live:         true        // default
      }
      ...
      photosRight = new WOW(
        {
        boxClass:     'Timeline-Memory:nth-of-type(2n)',      // default
        animateClass: 'animate__backInRight', // default
        offset:       300,          // default
        mobile:       true,       // default
        live:         true        // default
      }
